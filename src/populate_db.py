...
def get_table(config, meta):
    return Table(
        ...
        Column("is_week_goal", Boolean, nullable=False),
        Column("is_month_goal", Boolean, nullable=False),
        Column("is_quarter_goal", Boolean, nullable=False),
        Column("is_annual_goal", Boolean, nullable=False),
    ...
    with engine.connect() as connection:
        for task in task_list.tasks:
            in_stmt = tableSleep.insert().values(
                ...
                is_week_goal=task.is_week_goal,
                is_month_goal=task.is_month_goal,
                is_quarter_goal=task.is_quarter_goal,
                is_annual_goal=task.is_annual_goal,
